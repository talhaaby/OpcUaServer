...
namespace OpcUa.DI
{
    public partial class FileSystemLoadingModel : SoftwareLoadingModel, IFileSystemLoadingMethods
    {
        /// <summary>
        ...
        /// <returns></returns>
        public StatusCode GetUpdateBehavior(
        ...
        /// <returns></returns>
        public StatusCode ValidateFiles(
            RequestContext context,
            FileSystemLoadingModel model,
            NodeId[] NodeIds,
            out int ErrorCode,
